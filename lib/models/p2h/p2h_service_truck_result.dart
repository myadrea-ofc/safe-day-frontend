...
class P2HServiceTruckModel {
  ...
  final String penjelasanKondisiUnit;
  ...
  P2HServiceTruckModel({
    ...
    required this.penjelasanKondisiUnit,
  ...
  factory P2HServiceTruckModel.fromJson(Map<String, dynamic> json) {
    ...
    return P2HServiceTruckModel(
      ...
      opsiKeselamatan1: json['opsi_standar_keselamatan1'] ?? '',
      opsiKeselamatan2: json['opsi_standar_keselamatan2'] ?? '',
      opsiKeselamatan3: json['opsi_standar_keselamatan3'] ?? '',

      penjelasanKondisiUnit: json['penjelasan_kondisi_unit'] ?? '',

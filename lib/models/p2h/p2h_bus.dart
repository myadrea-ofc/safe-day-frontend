...
class P2HBusModel {
  ...
  final String opsiKeselamatan1;
  final String opsiKeselamatan2;
  final String opsiKeselamatan3;
  final String opsiKeselamatan4;

  final String opsiMasukTambang1;
  final String opsiMasukTambang2;
  final String opsiMasukTambang3;
  final String opsiMasukTambang4;
  final String opsiMasukTambang5;
  ...
  P2HBusModel({
    ...
    required this.opsiKeselamatan1,
    required this.opsiKeselamatan2,
    required this.opsiKeselamatan3,
    required this.opsiKeselamatan4,

    required this.opsiMasukTambang1,
    required this.opsiMasukTambang2,
    required this.opsiMasukTambang3,
    required this.opsiMasukTambang4,
    required this.opsiMasukTambang5,
  ...
  factory P2HBusModel.fromJson(Map<String, dynamic> json) {
    ...
    return P2HBusModel(
      ...
      opsiKeselamatan1: json['opsi_keselamatan1'] ?? '',
      opsiKeselamatan2: json['opsi_keselamatan2'] ?? '',
      opsiKeselamatan3: json['opsi_keselamatan3'] ?? '',
      opsiKeselamatan4: json['opsi_keselamatan4'] ?? '',

      opsiMasukTambang1: json['opsi_masuk_tambang1'] ?? '',
      opsiMasukTambang2: json['opsi_masuk_tambang2'] ?? '',
      opsiMasukTambang3: json['opsi_masuk_tambang3'] ?? '',
      opsiMasukTambang4: json['opsi_masuk_tambang4'] ?? '',
      opsiMasukTambang5: json['opsi_masuk_tambang5'] ?? '',

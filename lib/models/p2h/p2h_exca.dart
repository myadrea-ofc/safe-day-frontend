...
class P2HExcaModel {
  ...
  final String hmSekarang;
  final String waktuP2H;
  ...
  final String opsiStandarKeselamatan4;
  ...
  P2HExcaModel({
    ...
    required this.hmSekarang,
    required this.waktuP2H,
    ...
    required this.opsiStandarKeselamatan4,
    ...
    required this.lokKerja,
  });

  factory P2HExcaModel.fromJson(Map<String, dynamic> json) {
    ...
    return P2HExcaModel(
      ...
      hmSekarang: json['hm_sekarang'],
      waktuP2H: json['waktu_p2h'],
      ...
      opsiStandarKeselamatan4: json['opsi_standar_keselamatan4'],

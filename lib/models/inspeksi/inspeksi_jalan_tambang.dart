class InspeksiJalanTambangModel {
  final int id;
  final String nama;
  final String nrp;
  ...
  factory InspeksiJalanTambangModel.fromJson(Map<String, dynamic> json) {
    return InspeksiJalanTambangModel(
      id: json['id'],
      nama: json['nama'] ?? '',
      nrp: json['nrp'] ?? '',

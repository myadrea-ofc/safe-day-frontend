class InspeksiFasilitasBBMModel {
  final int id;
  final String nama;
  final String nrp;
  ...
  factory InspeksiFasilitasBBMModel.fromJson(Map<String, dynamic> json) {
    return InspeksiFasilitasBBMModel(
      id: json['id'] ?? 0,
      nama: json['nama'] ?? '',
      nrp: json['nrp'] ?? '',

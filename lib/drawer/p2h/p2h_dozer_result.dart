...
class P2HDozerResultPage extends StatefulWidget {
  ...
  const P2HDozerResultPage({super.key, this.openDetailId});
  @override
...
class _P2HDozerResultPageState extends State<P2HDozerResultPage>
  ...
  List<P2HDozerModel> _applySearchAndDate() {
  ...
  List<ExcelAccess> get _sortedAccessNewest {
    final list = List<ExcelAccess>.from(
      _accessList.where((a) => a.feature == "p2h_dozer"),
    );
  ...
  Widget _table() {
    ...
    final columns = const [
      ...
      DataColumn2(label: Center(child: Text("HM Dozer")), fixedWidth: 200),
      DataColumn2(label: Center(child: Text("Brand Unit")), fixedWidth: 180),
    ...
    showModalBottomSheet(
      ...
      builder: (_) {
        return ResultDetailBottomSheet(
          title: "Detail Laporan P2H Dozer",
          ...
          content: Column(
            ...
            children: [
              ...
              pairP2H(
                context,
                flatBoxP2H("No Lambung Dozer", e.noLambungUnit),
                flatBoxP2H("No Dozer saat ini", e.hmUnit),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
              ...
              pairP2H(
                ...
                flatBoxP2H("Kondisi Wiper", e.opsiItem6),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
              ...
              pairP2H(
                ...
                flatBoxP2H("Sistem Hidrolika", e.opsiItem16),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                ...
                flatBoxP2H("Mesin", e.opsiItem18),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                flatBoxP2H("Crawler Tracks", e.opsiItem19),
                flatBoxP2H("Crawler Track Link Bolts", e.opsiItem20),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                flatBoxP2H("Sistem Elektrik", e.opsiItem21),
                flatBoxP2H("Blade (Dozer / Grader)", e.opsiItem22),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                flatBoxP2H("Bajak & Gigi / Ripper & Teeth", e.opsiItem23),
                flatBoxP2H("Pengatur Arah / Directional Control", e.opsiItem24),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
              ...
              pairP2H(
                context,
                flatBoxP2H("Instrumen Panel", e.opsiItem27),

  ...
  Future<void> loadData() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Gagal memuat data P2H FuelTruck: $e")),
      );
    }
  }
      ...
      child: ClipRRect(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            hintText:
                "Cari nama / perusahaan / department / jabatan / nrp / unit / shift …",
          ...
          children: [
            ...
            DataTable2(
              ...
              columns: const [
                ...
                DataColumn2(
                  label: Center(child: Text("No Lambung FuelTruck")),
                  fixedWidth: 220,
                ),
                DataColumn2(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _pair(
                        context,
                        _flatBox("No Lambung Fuel Truck", e.noLambungUnit),
                      ...
                      _pair(
                        ...
                        _flatBox("Mesin", e.opsiItem22),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Sistem Elektrik", e.opsiItem23),
                        _flatBox("Load Indicator", e.opsiItem24),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Instrumen Panel", e.opsiItem25),
                        _flatBox("Alat Pemadam Api", e.opsiItem26),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Kotak PK3", e.opsiItem27),
                        _flatBox("Sabuk Keselamatan", e.opsiItem28),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                      ...
                      const SizedBox(height: 12),
                      _flatBox("SIMPER Tersedia dan Aktif", e.opsiItem31),
                      const SizedBox(height: 12),
                      const Padding(
                        padding: EdgeInsets.symmetric(vertical: 16),
                        child: Divider(thickness: 0.5),

...
class P2HBusResultPage extends StatefulWidget {
  ...
  const P2HBusResultPage({super.key, this.openDetailId});
  @override
...
class _P2HBusResultPageState extends State<P2HBusResultPage>
  ...
  List<P2HBusModel> _applySearchAndDate() {
  ...
  List<ExcelAccess> get _sortedAccessNewest {
    final list = List<ExcelAccess>.from(
      _accessList.where((a) => a.feature == "p2h_bus"),
    );
  ...
  Widget _table() {
    ...
    final columns = const [
      ...
      DataColumn2(label: Center(child: Text("Siap Kerja")), fixedWidth: 140),
      DataColumn2(label: Center(child: Text("Dokumen")), fixedWidth: 140),
  ...
  DataRow _rowPremium(P2HBusModel e, int index) {
    ...
    return DataRow(
      ...
      cells: [
        ...
        DataCell(buildResultCellWrap(e.kmSekarang)),
        ...
        return ResultDetailBottomSheet(
          ...
          content: Column(
            ...
            children: [
              ...
              pairP2H(
                context,
                flatBoxP2H("No Lambung Bus", e.noLambungUnit),
                flatBoxP2H("KM Bus saat ini", e.kmSekarang),
              ),
              const SizedBox(height: 12),
              ...
              pairP2H(
                context,
                flatBoxP2H("Level Minyak Rem", e.opsiItem3),
                flatBoxP2H("Level Air Aki", e.opsiItem4),
              ),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("Kondisi Wiper", e.opsiItem5),
                flatBoxP2H("Ban Serap", e.opsiItem6),
              ),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("Kondisi Ban", e.opsiItem7),
                flatBoxP2H("Tekanan Ban", e.opsiItem8),
              ),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("Sekrup Ban", e.opsiItem9),
                flatBoxP2H("Kelurusan Ban", e.opsiItem10),
              ),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("Rem Kaki", e.opsiItem11),
                flatBoxP2H("Rem Tangan", e.opsiItem12),
              ),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("Lampu Depan & Belakang", e.opsiItem13),
                flatBoxP2H("Lampu Rotary", e.opsiItem14),
              ),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("Lampu Sen Kanan & Kiri", e.opsiItem15),
                flatBoxP2H("Lampu Bahaya", e.opsiItem16),
              ),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("Alarm Mundur", e.opsiItem17),
                flatBoxP2H("Kaca Depan, Belakang dan Samping", e.opsiItem18),
              ),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("Cermin Pandang Belakang & Sisi", e.opsiItem19),
                flatBoxP2H("Suhu Mesin", e.opsiItem20),
              ),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("Klakson", e.opsiItem21),
                flatBoxP2H("Uji Rem Fisik", e.opsiItem22),
              ),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("Reaksi Kemudi", e.opsiItem23),
                flatBoxP2H("Alat Pemadam Api Ringan", e.opsiItem24),
              ),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("Dongkrak & Penyangga", e.opsiItem25),
                flatBoxP2H("Kotak P3K", e.opsiItem26),
              ),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("Sabuk Keselamatan", e.opsiItem27),
                flatBoxP2H("Radio Komunikasi", e.opsiItem28),
              ),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("Scotlight Reflektor", e.opsiItem29),
                flatBoxP2H("Safety Cone", e.opsiItem30),
              ),
              const SizedBox(height: 12),

              flatBoxP2H("SIMPER", e.opsiItem31),
              const SizedBox(height: 12),
              ...
              pairP2H(
                context,
                flatBoxP2H("Jack", e.opsiKeselamatan3),
                flatBoxP2H("Kotak P3K", e.opsiKeselamatan4),
              ),
              const SizedBox(height: 12),
              ...
              buildResultSectionTitle("Standard Masuk ke Tambang"),

              flatBoxP2H("Scotlight Reflector", e.opsiMasukTambang1),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("No Lambung Unit", e.opsiMasukTambang2),
                flatBoxP2H("Radio Komunikasi", e.opsiMasukTambang3),
              ),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("Buggy Whip 4 Mtr", e.opsiMasukTambang4),
                flatBoxP2H("4WD", e.opsiMasukTambang5),
              ),

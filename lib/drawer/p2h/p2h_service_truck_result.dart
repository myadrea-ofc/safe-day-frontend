  ...
  Future<void> loadData() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Gagal memuat data P2H ServiceTruck: $e")),
      );
    }
  }
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    const Expanded(
                      child: Text(
                        "Detail Laporan P2H ServiceTruck",
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                        style: TextStyle(
                          fontSize: 20,
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _pair(
                        context,
                        _flatBox("No Lambung Service Truck", e.noLambungUnit),
                        _flatBox("HM Service Truck saat ini", e.hmUnit),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                      ...
                      _pair(
                        context,
                        _flatBox("Bocor Air Radiator", e.opsiItem3),
                        _flatBox("Level Minyak Rem", e.opsiItem4),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                      ...
                      _pair(
                        context,
                        _flatBox("Radio Komunikasi", e.opsiItem29),
                        _flatBox("SIMPER tersedia & aktif", e.opsiItem30),
                      ),
                      const SizedBox(height: 12),
                      const Padding(
                        padding: EdgeInsets.symmetric(vertical: 16),

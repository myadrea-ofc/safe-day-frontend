...
// ====== STATUS HELPER (SAMA PREMIUM RESULT) ======
...
class _P2HWaterTruckResultPageState extends State<P2HWaterTruckResultPage> {
  ...
  Future<void> loadData() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Gagal memuat data P2H Water Truck: $e")),
      );
    }
  }

  // ===== SEARCH (PREMIUM: contains + ranking) =====
      ...
      child: ClipRRect(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            hintText:
                "Cari nama / perusahaan / department / NRP / jabatan / unit / lokasi / HM …",
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        "Detail Laporan P2H Water Truck",
                        style: const TextStyle(
                          fontSize: 20,
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _pair(
                        context,
                        _flatBox("No Lambung Water Truck", e.noLambungUnit),
                      ...
                      _pair(
                        ...
                        _flatBox("Alarm Mundur", e.opsiItem12),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                      ...
                      _pair(
                        ...
                        _flatBox("Suhu Mesin", e.opsiItem16),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Klakson", e.opsiItem17),
                        _flatBox("Uji Rem Fisik", e.opsiItem18),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        ...
                        _flatBox("Reaksi Kemudi", e.opsiItem20),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Kemudi Darurat", e.opsiItem21),
                        _flatBox("Sistem Hidrolik", e.opsiItem22),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Silinder Hidrolik", e.opsiItem23),
                        _flatBox("Mesin", e.opsiItem24),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Sistem Elektrik", e.opsiItem25),
                        _flatBox("Kondisi Tangki", e.opsiItem26),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                      ...
                      _pair(
                        context,
                        _flatBox("Kotak PK3", e.opsiItem29),
                        _flatBox("Sabuk Keselamatan", e.opsiItem30),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Radio Komunikasi", e.opsiItem31),
                        _flatBox("Safety Cone", e.opsiItem32),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Ganjal Ban", e.opsiItem33),
                        _flatBox("SIMPER", e.opsiItem34),
                      ),
                      const SizedBox(height: 12),
                      ...
                      _pair(
                        context,
                        _flatBox("Kotak P3K", e.opsiKeselamatan2),
                        _flatBox("Rigger Tersedia", e.opsiKeselamatan3),
                      ),
  ...
  Future<void> downloadWithPopup({
    ...
    try {
      ...
      // ✅ kalau gambar: masuk Galeri (album Safe Day)

...
// ====== STATUS HELPER (SAMA PERSIS CRANE) ======
  ...
  Future<void> loadData() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Gagal memuat data P2H Forklift: $e")),
      );
    }
  }

  // ===== SEARCH (SAMA CRANE: contains + ranking) =====
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _pair(
                        ...
                        _flatBox("Shift Kerja", e.brandUnit),
                      ),
                      const SizedBox(height: 12),
                      _flatBox("Shift Kerja", e.lokasiKerja),
                      const SizedBox(height: 12),
                      ...
                      _pair(
                        ...
                        _flatBox(
                          "Keadaan Body dan Kursi Operator",
                          e.opsiItem12,
                        ),
                      ),
                      const SizedBox(height: 12),
                      ...
                      _pair(
                        context,
                        _flatBox("Reaksi Kemudi", e.opsiItem17),
                      ...
                      _pair(
                        ...
                        _flatBox("Mesin", e.opsiItem20),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Rantai Forklift", e.opsiItem21),
                        _flatBox("Kondisi Garpu", e.opsiItem22),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Sistem Elektrik", e.opsiItem23),
                        _flatBox("Tuas Kemudi", e.opsiItem24),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Tuas Penggeser Garpu", e.opsiItem25),
                        _flatBox(
                          "Tuas Menaikkan dan Menurunkan Garpu",
                          e.opsiItem26,
                        ),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Instrument Panel", e.opsiItem27),
                      ...
                      const SizedBox(height: 12),
                      _flatBox("SIO / SIMPER", e.opsiItem31),

...
class P2HCompactorResultPage extends StatefulWidget {
  ...
  const P2HCompactorResultPage({super.key, this.openDetailId});
  @override
...
class _P2HCompactorResultPageState extends State<P2HCompactorResultPage>
  ...
  List<P2HCompactorModel> _applySearchAndDate() {
  ...
  List<ExcelAccess> get _sortedAccessNewest {
    final list = List<ExcelAccess>.from(
      _accessList.where((a) => a.feature == "p2h_compactor"),
    );
                          ...
                          children: [
                            ...
                            if (_isAdminOrSuperadmin) ...[
                              ResultExcelAccessPanel(
                                ...
                                isEmpty: _accessList
                                    .where((a) => a.feature == "p2h_compactor")
                                    .isEmpty,
    ...
    showModalBottomSheet(
      ...
      builder: (_) {
        return ResultDetailBottomSheet(
          title: "Detail Laporan P2H Compactor",
          ...
          content: Column(
            ...
            children: [
              ...
              pairP2H(
                context,
                flatBoxP2H("No Lambung Compactor", e.noLambungUnit),
              ...
              pairP2H(
                context,
                flatBoxP2H("Tuas Kemudi", e.opsiItem19),
                flatBoxP2H("Sistem Hidrolik", e.opsiItem20),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                flatBoxP2H("Mesin", e.opsiItem21),
                flatBoxP2H("Kondisi Vibrator", e.opsiItem22),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                flatBoxP2H("Sistem Elektrik", e.opsiItem23),
                flatBoxP2H("Instrumen Panel", e.opsiItem24),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                flatBoxP2H("Alat Pemadam Api", e.opsiItem25),
              ...
              pairP2H(
                ...
                flatBoxP2H("SIMPER", e.opsiItem30),
              ),
              const SizedBox(height: 12),
              const Padding(
                padding: EdgeInsets.symmetric(vertical: 16),

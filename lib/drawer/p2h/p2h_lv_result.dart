...
class _P2HLVResultPageState extends State<P2HLVResultPage> {
  ...
  Future<void> loadData() async {
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text("Gagal memuat data P2H LV: $e")));
    }
  }
  ...
  List<P2HLVModel> _searchResults(String v) {
    ...
    final results = allData.where((e) {
      ...
      final noLv = safeLower(e.noLambungUnit);
      final lvNow = safeLower(e.lvSekarang);
      ...
      child: ClipRRect(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            hintText:
                "Cari nama / perusahaan / department / jabatan / brand / no LV / shift …",
          ...
          children: [
            ...
            DataTable2(
              ...
              columns: const [
                ...
                DataColumn2(
                  label: Center(child: Text("No Lambung LV")),
                  fixedWidth: 200,
                ),
                DataColumn2(
                  label: Center(child: Text("No Lambung LV Saat ini")),
                  fixedWidth: 240,
                ),
                DataColumn2(
  ...
  DataRow _rowPremium(P2HLVModel e, int index) {
    ...
    return DataRow(
      ...
      cells: [
        ...
        DataCell(cellWrap(e.lvSekarang)),
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _flatBox("Brand Unit", e.brandUnit),
                      const SizedBox(height: 12),

                      _pair(
                        context,
                        _flatBox("No Lambung LV", e.noLambungUnit),
                        _flatBox("No LV saat ini", e.lvSekarang),
                      ),
                      const SizedBox(height: 12),

                      _pair(
                        context,
                        _flatBox("tanggal Kejadian", formatTanggal(e.tanggal)),
                      ...
                      _pair(
                        context,
                        _flatBox("Level Oil Engine", e.opsiItem1),
                      ...
                      _pair(
                        ...
                        _flatBox("Kondisi Aki", e.opsiItem4),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Air Wiper dan Kondisi Wiper", e.opsiItem5),
                        _flatBox("Kondisi Ban", e.opsiItem6),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Ban Serap", e.opsiItem7),
                        _flatBox("Skrup Ban", e.opsiItem8),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Rem Kaki", e.opsiItem9),
                        _flatBox("Rem Tangan", e.opsiItem19),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        ...
                        _flatBox("Lampu Sein (Kiri & Kanan)", e.opsiItem11),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Lampu Hazard", e.opsiItem12),
                        _flatBox("Alarm Mundur", e.opsiItem13),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Klakson", e.opsiItem14),
                        _flatBox("Keadaan Body Mobil", e.opsiItem15),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Kaca Spion", e.opsiItem16),
                        _flatBox("Panel Engine", e.opsiItem17),
                      ),
                      const SizedBox(height: 12),
                      _flatBox("Kondisi AC", e.opsiItem18),
                      ...
                      _pair(
                        ...
                        _flatBox("Jack", e.opsiStandardKeselamatan3),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Kotak P3K", e.opsiStandardKeselamatan4),
                        _flatBox(
                      ...
                      _flatBox("Lampu Atap Kabin", e.opsiStandardMasukTambang1),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Lampu Rotari", e.opsiStandardMasukTambang2),
                        _flatBox(
                          "Scotlight Reflector",
                          e.opsiStandardMasukTambang3,
                        ),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        ...
                        _flatBox(
                          "No Lambung Unit",
                          e.opsiStandardMasukTambang4,
                        ),
                        _flatBox(
                          "Radio Komunikasi",
                          e.opsiStandardMasukTambang5,
                        ),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        ...
                        _flatBox(
                          "Buggy Whip 4 Mtr",
                          e.opsiStandardMasukTambang6,
                        ),
                        _flatBox("4WD", e.opsiStandardMasukTambang7),
                      ),
  ...
  // ===== FILES DIALOG (konsisten premium) =====

  ...
  Future<void> loadData() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Gagal memuat data P2H Crane: $e")),
      );
    }
  }
      ...
      child: ClipRRect(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            hintText:
                "Cari nama / NRP / perusahaan / department / jabatan / unit / lokasi / shift …",
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _pair(
                        context,
                        _flatBox("No Lambung Crane", e.noLambungUnit),
                        _flatBox("HM Crane saat ini", e.hmUnit),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                      ...
                      _pair(
                        ...
                        _flatBox("Bahan Bakar & Oli Mesin", e.opsiItem2),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Kondisi Wiper", e.opsiItem3),
                        _flatBox(
                      ...
                      _pair(
                        context,
                        _flatBox("Overload Alarm", e.opsiItem9),
                        _flatBox(
                      ...
                      _pair(
                        ...
                        _flatBox("Reaksi Kemudi", e.opsiItem14),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Tuas Kemudi", e.opsiItem15),
                        _flatBox("Sistem Hidrolik dan Kebocoran", e.opsiItem16),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Silinder Hidrolik", e.opsiItem17),
                        _flatBox("Sistem Elektrik", e.opsiItem18),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        ...
                        _flatBox("Crawler Tracks dan Link Bolt", e.opsiItem20),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                      ...
                      _pair(
                        context,
                        _flatBox("Indikator Radius Sudut Boom", e.opsiItem23),
                        _flatBox("Limit Pengangkat pada Boom", e.opsiItem24),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Tabel Pengangkat pada Boom", e.opsiItem25),
                        _flatBox(
                      ...
                      _pair(
                        ...
                        _flatBox("Teromol Pengangkatan / Pully", e.opsiItem28),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Radio Komunikasi", e.opsiItem35),
                        _flatBox("SIO / SIMPER", e.opsiItem36),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox(
                          "Drum Tempat Putaran Seling / Tali",
                          e.opsiItem29,
                        ),
                        _flatBox("Shackle", e.opsiItem30),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Instrumen Panel", e.opsiItem31),
                        _flatBox("Alat Pemadam Api", e.opsiItem32),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Kotak PK3", e.opsiItem33),
                        _flatBox("Sabuk Keselamatan", e.opsiItem34),
                      ),
                      const SizedBox(height: 12),
                      ...
                      _pair(
                        ...
                        _flatBox("Jack", e.opsiStandarKeselamatan3),
                      ),

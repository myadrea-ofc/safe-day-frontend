...
class _P2HWheelLoaderResultPageState extends State<P2HWheelLoaderResultPage> {
  ...
  Future<void> loadData() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Gagal memuat data P2H WheelLoader: $e")),
      );
    }
  }
          ...
          children: [
            ...
            DataTable2(
              ...
              columns: const [
                ...
                DataColumn2(
                  label: Center(child: Text("No Lambung WheelLoader")),
                  fixedWidth: 220,
                ),
                DataColumn2(
  ...
  // ===== DETAIL (DATA & LABEL TIDAK DIUBAH) =====
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        "Detail Laporan P2H Wheel Loader",
                        style: const TextStyle(
                          fontSize: 20,
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _pair(
                        context,
                        _flatBox("No Lambung WheelLoader", e.noLambungUnit),
                      ...
                      _pair(
                        context,
                        _flatBox("Reaksi Kemudi", e.opsiItem19),
                        _flatBox("Tuas Kemudi", e.opsiItem20),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                      ...
                      _pair(
                        ...
                        _flatBox("Kondisi Shovel", e.opsiItem24),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                      ...
                      _pair(
                        ...
                        _flatBox("Kotak PK3", e.opsiItem28),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
  ...
  // ===== FLATBOX (premium status-aware, tanpa ubah label/data) =====

      ...
      child: ClipRRect(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            hintText:
                "Cari nama / perusahaan / department / jabatan / unit / lokasi / shift / HM …",
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _pair(
                        context,
                        _flatBox("No Lambung Truck", e.noLambungUnit),
                      ...
                      _pair(
                        context,
                        _flatBox("Reaksi Kemudi", e.opsiItem21),
                        _flatBox("Kemudi Darurat", e.opsiItem22),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Sistem Hidrolik", e.opsiItem23),
                        _flatBox("Silinder Hidrolik", e.opsiItem24),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Mesin", e.opsiItem25),
                        _flatBox("Sistem Elektrik", e.opsiItem26),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                      ...
                      _pair(
                        context,
                        _flatBox("Safety Cone", e.opsiItem31),
                        _flatBox("Ganjal Ban", e.opsiItem32),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                      ...
                      _pair(
                        context,
                        _flatBox("Jack", e.opsiStandarKeselamatan2),
                        _flatBox(
                          "Safety Cone / Segitiga",
                          e.opsiStandarKeselamatan3,
                        ),
                      ),
                      const SizedBox(height: 12),

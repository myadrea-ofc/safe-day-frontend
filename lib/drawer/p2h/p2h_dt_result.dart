...
class P2HDTResultPage extends StatefulWidget {
  ...
  const P2HDTResultPage({super.key, this.openDetailId});
  @override
...
class _P2HDTResultPageState extends State<P2HDTResultPage>
  ...
  List<P2HDTModel> _applySearchAndDate() {
  ...
  List<ExcelAccess> get _sortedAccessNewest {
    final list = List<ExcelAccess>.from(
      _accessList.where((a) => a.feature == "p2h_dt"),
    );
          ...
          content: Column(
            ...
            children: [
              ...
              pairP2H(
                ...
                flatBoxP2H("HM Unit saat ini", e.hmSekarang),
              ),
              const SizedBox(height: 12),
              ...
              pairP2H(
                context,
                flatBoxP2H("Bocor Radiator", e.opsiItem7),
                flatBoxP2H(
              ...
              pairP2H(
                ...
                flatBoxP2H("Alarm Mundur", e.opsiItem10),
              ),
              const SizedBox(height: 12),
              ...
              pairP2H(
                ...
                flatBoxP2H("cermin pandang belakang & sisi", e.opsiItem12),
              ),
              const SizedBox(height: 12),
              ...
              pairP2H(
                ...
                flatBoxP2H("Alat pelambat / Tetrader Control", e.opsiItem16),
              ),
              const SizedBox(height: 12),
              ...
              pairP2H(
                ...
                flatBoxP2H("Reaksi kemudi", e.opsiItem18),
              ),
              const SizedBox(height: 12),
              ...
              pairP2H(
                ...
                flatBoxP2H("Kemudi Darurat", e.opsiItem20),
              ),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("Sistem Hidrolik", e.opsiItem21),
                flatBoxP2H("Silinder Hidrolik", e.opsiItem22),
              ),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("Mesin", e.opsiItem23),
                flatBoxP2H("Sistem Elektrik", e.opsiItem24),
              ),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("Load Indicator", e.opsiItem25),
                flatBoxP2H("Instrumen panel", e.opsiItem26),
              ),
              const SizedBox(height: 12),

              pairP2H(
                context,
                flatBoxP2H("Alat Pemadam Api", e.opsiItem27),
                flatBoxP2H("Kotak P3K", e.opsiItem28),
              ),
              const SizedBox(height: 12),
              ...
              flatBoxP2H("SIMPER tersedia & aktif", e.opsiItem31),
              const SizedBox(height: 12),
              ...
              const SizedBox(height: 12),
              flatBoxP2H("Jam Tidur Anda", e.jamOperasi),
              const SizedBox(height: 12),

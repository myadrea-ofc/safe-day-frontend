...
class P2HTowerLampResultPage extends StatefulWidget {
  ...
  const P2HTowerLampResultPage({super.key, this.openDetailId});
  @override
...
class _P2HTowerLampResultPageState extends State<P2HTowerLampResultPage>
  ...
  List<P2HTowerlampModel> _applySearchAndDate() {
  ...
  List<ExcelAccess> get _sortedAccessNewest {
    final list = List<ExcelAccess>.from(
      _accessList.where((a) => a.feature == "p2h_towerlamp"),
    );
                          ...
                          children: [
                            ...
                            if (_isAdminOrSuperadmin) ...[
                              ResultExcelAccessPanel(
                                ...
                                isEmpty: _accessList
                                    .where((a) => a.feature == "p2h_towerlamp")
                                    .isEmpty,
    ...
    showModalBottomSheet(
      ...
      builder: (_) {
        return ResultDetailBottomSheet(
          title: "Detail Laporan P2H Tower Lamp",
          ...
          content: Column(
            ...
            children: [
              ...
              pairP2H(
                context,
                flatBoxP2H("Kondisi Hose", e.opsiItem3),
                flatBoxP2H("Kondisi Lampu", e.opsiItem4),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                flatBoxP2H("Filter Udara", e.opsiItem5),
                flatBoxP2H("Sling Condition", e.opsiItem6),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                flatBoxP2H("Alat Pemadam Api Ringan", e.opsiItem7),
              ...
              pairP2H(
                context,
                flatBoxP2H("Kondisi Lampu Menara", e.opsiItem11),
              ...
              pairP2H(
                context,
                flatBoxP2H("Skidding", e.opsiItem15),
                flatBoxP2H("Level BBM", e.opsiItem16),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                flatBoxP2H("Gandengan", e.opsiItem17),
                flatBoxP2H("Penutup Mesin", e.opsiItem18),
              ),
              const SizedBox(height: 12),
              flatBoxP2H("Kondisi Mur / Baut", e.opsiItem19),

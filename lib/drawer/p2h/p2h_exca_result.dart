...
// ====== STATUS HELPER (samakan P2HDTResult) ======
...
class _P2HExcaResultPageState extends State<P2HExcaResultPage> {
  ...
  Future<void> loadData() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Gagal memuat data P2H Excavator: $e")),
      );
    }
  }

  // ===== SEARCH (samakan P2HDTResult: contains + ranking ringan) =====
  ...
  // ===== APPBAR PREMIUM (samakan P2HDTResult) =====
  ...
  // ===== SEARCH BOX PREMIUM (samakan P2HDTResult) =====
  ...
  // ===== TABLE PREMIUM (samakan P2HDTResult) =====
          ...
          children: [
            ...
            DataTable2(
              ...
              columns: const [
                ...
                DataColumn2(
                  label: Center(child: Text("No Unit Exca")),
                  fixedWidth: 200,
                ),
                DataColumn2(
  ...
  // ===== PAGINATION PREMIUM (samakan P2HDTResult) =====
  ...
  // ====== DETAIL: ISI & LABEL TETAP PUNYAMU ======
  void showDetail(P2HExcaModel e) {
    // ✅ NOTE: isi & label di bawah ini TIDAK aku ubah,
    // hanya _pair + _flatBox yang disamakan gaya seperti DT.
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _pair(
                        context,
                        _flatBox("No Unit Excavator", e.noLambungUnit),
                        _flatBox("No Exca saat ini", e.hmSekarang),
                      ),
                      const SizedBox(height: 12),
                      ...
                      _flatBox("Lokasi Kerja", e.lokKerja),
                      ...
                      _pair(
                        context,
                        _flatBox("Level Air Radiator", e.opsiItem1),
                        _flatBox(
                          "Level Bocor RAdiator atau Pipa Air",
                          e.opsiItem2,
                        ),
                      ),
                      const SizedBox(height: 12),
                      ...
                      _pair(
                        ...
                        _flatBox("Suhu Mesin", e.opsiItem12),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Klakson", e.opsiItem13),
                        _flatBox("Sistem Hidrolik", e.opsiItem14),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Silinder Hidrolik", e.opsiItem15),
                        _flatBox("Kondisi Mesin", e.opsiItem16),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Crawler Tracks", e.opsiItem17),
                        _flatBox("Crawler Track Link Bolts", e.opsiItem18),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Bucket / Shovel & Gigi", e.opsiItem19),
                        _flatBox("Lampu Boom", e.opsiItem20),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Sistem Elektrik", e.opsiItem21),
                        _flatBox("Instrumen Panel", e.opsiItem22),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        _flatBox("Kebocoran Hose", e.opsiItem23),
                        _flatBox(
                      ...
                      _pair(
                        context,
                        _flatBox("Kotak P3K Tersedia", e.opsiItem25),
                        _flatBox("Sabuk Keselamatan", e.opsiItem26),
                      ),
                      const SizedBox(height: 12),
                      _pair(
                        context,
                        ...
                        _flatBox("SIMPER Tersedia", e.opsiItem28),
                      ),
                      ...
                      _pair(
                        ...
                        _flatBox("Kotak P3K", e.opsiStandarKeselamatan4),
                      ),
  ...
  // ===== helper pair responsive (samakan DT) =====
  Widget _pair(
  ...
  // ===== DOKUMEN DIALOG (samakan DTResult: header gradien + close gradien) =====
  ...
  // ===== preview & download: logic kamu (tetap) =====

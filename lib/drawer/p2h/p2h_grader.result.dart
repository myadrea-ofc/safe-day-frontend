...
class P2HGraderResultPage extends StatefulWidget {
  ...
  const P2HGraderResultPage({super.key, this.openDetailId});
  @override
...
class _P2HGraderResultPageState extends State<P2HGraderResultPage>
  ...
  List<P2HGraderModel> _applySearchAndDate() {
  ...
  List<ExcelAccess> get _sortedAccessNewest {
    final list = List<ExcelAccess>.from(
      _accessList.where((a) => a.feature == "p2h_grader"),
    );
  ...
  Widget _table() {
    ...
    final columns = const [
      ...
      DataColumn2(label: Center(child: Text("HM Saat ini")), fixedWidth: 200),
    ...
    showModalBottomSheet(
      ...
      builder: (_) {
        return ResultDetailBottomSheet(
          title: "Detail Laporan P2H Grader",
          ...
          content: Column(
            ...
            children: [
              ...
              pairP2H(
                context,
                flatBoxP2H("No Lambung Grader", e.noLambungUnit),
                flatBoxP2H("No Grader saat ini", e.hmUnit),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                ...
                flatBoxP2H("Lokasi Kerja", e.lokasiKerja),
              ),
              ...
              pairP2H(
                context,
                flatBoxP2H("Level Air Radiator & Kebocoran", e.opsiItem1),
                flatBoxP2H("Level Minyak Rem", e.opsiItem2),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                flatBoxP2H("Level Air Aki", e.opsiItem3),
                flatBoxP2H("Bahan Bakar & Oli Mesin", e.opsiItem4),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
              ...
              pairP2H(
                context,
                flatBoxP2H("Cermin Pandang Belakang & Sisi", e.opsiItem11),
                flatBoxP2H(
              ...
              pairP2H(
                context,
                flatBoxP2H("Kondisi Mesin dan Suhu Mesin", e.opsiItem13),
              ...
              pairP2H(
                ...
                flatBoxP2H("Reaksi Kemudi", e.opsiItem16),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                flatBoxP2H("Kemudi Darurat", e.opsiItem17),
                flatBoxP2H("Sistem Hidrolik", e.opsiItem18),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                flatBoxP2H("Silinder Hidrolik", e.opsiItem19),
                flatBoxP2H("Sistem Elektrik", e.opsiItem20),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                flatBoxP2H("Blade", e.opsiItem21),
                flatBoxP2H("Grader Blade Turntable", e.opsiItem22),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                flatBoxP2H("Bajak & Gigi", e.opsiItem23),
                flatBoxP2H("Pengatur Arah", e.opsiItem24),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                flatBoxP2H("Tuas Kemudi / Control Levers", e.opsiItem25),
                flatBoxP2H(
              ...
              pairP2H(
                context,
                flatBoxP2H("Sistem Monitor", e.opsiItem27),
                flatBoxP2H("Alat Pemadam Api", e.opsiItem28),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                flatBoxP2H("Kotak P3K", e.opsiItem29),
                flatBoxP2H("Tongkat 4 m & Bendera", e.opsiItem30),
              ),
              const SizedBox(height: 12),
              pairP2H(
                context,
                flatBoxP2H("Sabuk Keselamatan", e.opsiItem31),
                flatBoxP2H("Radio Komunikasi", e.opsiItem32),
              ),
              const SizedBox(height: 12),
              flatBoxP2H("SIMPER", e.opsiItem33),
              ...
              pairP2H(
                ...
                flatBoxP2H("Kotak P3K", e.opsiStandarKeselamatan3),
              ),

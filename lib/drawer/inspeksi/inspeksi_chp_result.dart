...
class _InspeksiCHPResultPageState extends State<InspeksiCHPResultPage> {
  ...
  // ====== SEARCH mirip P5M (contains + ranking ringan) ======
  ...
  DataRow _rowPremium(InspeksiCHPModel e, int index) {
    ...
    return DataRow(
      ...
      cells: [
        ...
        // Temuan 1-4 = tombol foto (ikut pola p5m)
  ...
  // ====== SHOW FOTO (logic kamu tetap, hanya header ikut theme) ======
  ...
  // ====== DETAIL: aku hanya samakan gradient icon & tombol tutup, isi tetap punyamu ======
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Jalur & tempat berjalan aman", e.opsi5),
                      const SizedBox(height: 12),
                      _flatBox("Tersedia penutup belt (kerudung)", e.opsi6),
                      const SizedBox(height: 12),
                      _flatBox("Tersedia alat LOTO & tanda bahaya", e.opsi7),
                      const SizedBox(height: 12),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Tersedia Saklar Pembatas Trip", e.opsi9),
                      const SizedBox(height: 12),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Rollers & Idlers semua bekerja", e.opsi12),
                      const SizedBox(height: 12),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Belt bertumpu secara benar", e.opsi15),
                      const SizedBox(height: 12),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Tersedia pemadam api & di inspeksi", e.opsi19),
                      const SizedBox(height: 12),
                      _flatBox("Tersedia peringatan untuk Start Up", e.opsi20),
                      const Padding(
                        padding: EdgeInsets.symmetric(vertical: 16),
                        child: Divider(thickness: 0.5),
                      ),

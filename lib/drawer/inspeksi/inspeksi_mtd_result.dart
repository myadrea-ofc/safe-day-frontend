...
class _InspeksiMTDResultPageState extends State<InspeksiMTDResultPage> {
  ...
  Future<void> loadData() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Gagal memuat data inspeksi MTD: $e")),
      );
    }
  }
  ...
  // ====== DETAIL (STYLE DISAMAKAN, ISI TETAP MTD) ======
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Expanded(
                      child: Text(
                        "Detail Laporan Inspeksi Mess, Toilet dan Dapur",
                        softWrap: true,
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _sectionTitle("Kondisi Mess, Toilet dan Dapur"),
                      _flatBox(
                        "Saluran Drainase Bersih / Tidak Tersumbat & Didisinfeksi",
                        e.opsi1,
                      ),
                      const SizedBox(height: 12),
                      _flatBox("Lantai bersih dan didisinfeksi", e.opsi2),
                      const SizedBox(height: 12),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Penerangan memadai", e.opsi5),
                      const SizedBox(height: 12),
                      _flatBox("Ventilasi / Ekstraksi memadai", e.opsi6),
                      const SizedBox(height: 12),
                      _flatBox("Kebersihan & Housekeeping yang baik", e.opsi7),
                      const SizedBox(height: 12),
                      _flatBox("Cermin bersih & tidak pecah", e.opsi8),
                      const SizedBox(height: 12),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Toilet bersih & didisinfeksi", e.opsi10),
                      const SizedBox(height: 12),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Tempat tidur / kamar bersih / rapih", e.opsi12),
                      const SizedBox(height: 12),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Pentanahan disediakan", e.opsi16),
                      const SizedBox(height: 12),
                      _flatBox("Instalasi gas terkompresi aman", e.opsi17),
                      const SizedBox(height: 12),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Bak cuci (wastafe) bersih", e.opsi22),
                      const SizedBox(height: 12),
                      _flatBox(

...
class InspeksiPlantResultPage extends StatefulWidget {
  ...
  const InspeksiPlantResultPage({super.key, this.openDetailId});
  @override
...
class _InspeksiPlantResultPageState extends State<InspeksiPlantResultPage>
  ...
  List<InspeksiPlantModel> _applySearchAndDate() {
  ...
  List<ExcelAccess> get _sortedAccessNewest {
    final list = List<ExcelAccess>.from(
      _accessList.where((a) => a.feature == "inspeksi_plant"),
    );
                          ...
                          children: [
                            ...
                            ResultDateFilterBar(
                              ...
                              onExportExcel: () async {
                                ...
                                await exportExcelCurrentFilter(
                                  ...
                                  canCurrentUserDownloadExcel:
                                      _canCurrentUserDownloadExcel,
                                  type: ExportType.inspeksi_plant,
                                  range: _presetRange(_datePreset),
                                  onNoAccess: () =>
                            ...
                            if (_isAdminOrSuperadmin) ...[
                              ResultExcelAccessPanel(
                                ...
                                isEmpty: _accessList
                                    .where((a) => a.feature == "inspeksi_plant")
                                    .isEmpty,
    ...
    showModalBottomSheet(
      ...
      builder: (_) {
        return ResultDetailBottomSheet(
          title: "Detail Laporan Inspeksi Plant",
          ...
          content: Column(
            ...
            children: [
              ...
              buildResultSectionTitle("Kondisi Plant"),
              inspeksiFlatBox(
              ...
              const SizedBox(height: 12),
              inspeksiFlatBox("Tabir Las dipakai", e.opsi21),
              const SizedBox(height: 12),
              inspeksiFlatBox(

...
class _InspeksiFasilitasBBMResultPageState
  ...
  Future<void> loadData() async {
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text("Gagal memuat data inspeksi: $e")));
    }
  }
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                const Expanded(
                  child: Text(
                    "Inspeksi Fasilitas BBM Results",
                    style: TextStyle(
        ...
        child: Stack(
          children: [
            ...
            DataTable2(
              columnSpacing: 26,
              horizontalMargin: 16,
              minWidth: 3800, // sama seperti CHP premium
              fixedTopRows: 1,
              headingRowHeight: 60,
              dataRowHeight: 66,
  ...
  // ====== SHOW DETAIL (STYLE PERSIS CHP, ISI BBM) ======
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Expanded(
                      child: Text(
                        "Detail Laporan Inspeksi Fasilitas BBM",
                        softWrap: true,
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _sectionTitle("Kondisi Fasilitas BBM"),
                      _flatBox("Bocoran dari Selang / Sambungan", e.opsi1),
                      const SizedBox(height: 12),
                      _flatBox("Tumpahan (di lantai / di tanah)", e.opsi2),
                      const SizedBox(height: 12),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Penerangan area yang mencukupi", e.opsi8),
                      const SizedBox(height: 12),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Saluran pengisian kosong", e.opsi12),
                      const SizedBox(height: 12),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Pentahanan / Bonding", e.opsi14),
                      const SizedBox(height: 12),
                      _flatBox(
                        "Tutup katup Discharge pada tempatnya",
                        e.opsi15,
                      ),
                      const SizedBox(height: 12),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox(
                        "Tersedia pemadam api dan di inspeksi",
                        e.opsi19,
                      ),
                      const SizedBox(height: 12),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Tempat sampah (dengan tutup)", e.opsi21),
                      const Padding(
                        padding: EdgeInsets.symmetric(vertical: 16),
                        child: Divider(thickness: 0.5),
                      ),

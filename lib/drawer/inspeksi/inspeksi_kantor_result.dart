...
class _InspeksiKantorResultPageState extends State<InspeksiKantorResultPage> {
  ...
  Future<void> loadData() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Gagal memuat data inspeksi Kantor: $e")),
      );
    }
  }
  ...
  // ====== DETAIL (STYLE DISAMAKAN, ISI TETAP KANTOR) ======
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Expanded(
                      child: Text(
                        "Detail Laporan Inspeksi Kantor",
                        softWrap: true,
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Terdapat pencahayaan yang cukup", e.opsi3),
                      const SizedBox(height: 12),
                      _flatBox(

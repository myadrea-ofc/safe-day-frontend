...
class _InspeksiJalanTambangResultPageState
  ...
  Future<void> loadData() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Gagal memuat data inspeksi Jalan Tambang: $e")),
      );
    }
  }
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                const Expanded(
                  child: Text(
                    "Inspeksi Jalan Tambang Results",
                    style: TextStyle(
  ...
  // ====== FOTO (LOGIC SAMA, UI CHP PREMIUM) ======
  ...
  // ====== DETAIL (STYLE CHP, ISI TETAP JALAN TAMBANG) ======
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Expanded(
                      child: Text(
                        "Detail Laporan Inspeksi Jalan Tambang",
                        softWrap: true,
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _sectionTitle("Kondisi Lapangan"),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox("House keeping / kebersihan tambang", e.opsi4),
                      const SizedBox(height: 12),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Rambu-rambu lalu lintas memadai", e.opsi7),
                      const SizedBox(height: 12),
                      _flatBox("Karyawan memakai APD sesuai standar", e.opsi8),
                      const SizedBox(height: 12),
                      _flatBox("Ada rambu petunjuk arah ke PIT", e.opsi9),
                      const SizedBox(height: 12),
                      _flatBox("Setiap kendaraan dilengkapi P3K", e.opsi10),
                      const SizedBox(height: 12),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Klakson digunakan dengan disiplin", e.opsi12),
                      const SizedBox(height: 12),
                      _flatBox("Jalan angkut rata dan bebas batuan", e.opsi13),
                      const SizedBox(height: 12),
                      _flatBox("Lebar jalan angkut sesuai standar", e.opsi14),
                      const SizedBox(height: 12),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Tikungan buta ada cermin cembung", e.opsi16),
                      const SizedBox(height: 12),
                      _flatBox(
                      ...
                      const SizedBox(height: 12),
                      _flatBox("Pompa/tower lamp ada pengaman", e.opsi19),
                      const SizedBox(height: 12),
                      _flatBox("Sling dan alat angkat lengkap KIP", e.opsi20),
                      const SizedBox(height: 12),
                      _flatBox("Semua unit punya lampu rotary", e.opsi21),
                      const SizedBox(height: 12),
                      _flatBox(

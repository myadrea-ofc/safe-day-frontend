...
class InspeksiKantorService {
  static const _storage = FlutterSecureStorage();
  static const baseUrl = "http://safety.borneo.co.id/inspeksi_kantor";

  static Future<bool> submitInspeksiKantor({
    ...
    debugPrint("SUBMIT INSPEKSI KANTOR STATUS: ${response.statusCode}");
    debugPrint("SUBMIT INSPEKSI KANTOR RESPONSE: $responseBody");

    return response.statusCode == 200 || response.statusCode == 201;
  }

  static Future<List<InspeksiKantorModel>> fetchInspeksiKantor() async {
    final token = await _storage.read(key: "jwt_token");
    final deviceId = await _storage.read(key: "device_id");
    ...
    try {
      ...
      return data.map((e) => InspeksiKantorModel.fromJson(e)).toList();
    } catch (e) {
      debugPrint("Error Fetch Inspeksi Kantor: $e");
      return [];
    }
  }
}

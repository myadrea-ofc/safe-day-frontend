...
class InspeksiPlantService {
  static const _storage = FlutterSecureStorage();
  static const baseUrl = "http://safety.borneo.co.id/inspeksi_plant";

  static Future<bool> submitInspeksiPlant({
    ...
    required String opsi23,
    required String opsi24,
    required String opsi25,
    required String opsi26,
    ...
    debugPrint("SUBMIT INSPEKSI PLANT STATUS: ${response.statusCode}");
    debugPrint("SUBMIT INSPEKSI PLANT RESPONSE: $responseBody");

    return response.statusCode == 200 || response.statusCode == 201;
  }

  static Future<List<InspeksiPlantModel>> fetchInspeksiPlant() async {
    final token = await _storage.read(key: "jwt_token");
    final deviceId = await _storage.read(key: "device_id");
    ...
    try {
      ...
      return data.map((e) => InspeksiPlantModel.fromJson(e)).toList();
    } catch (e) {
      debugPrint("Error Fetch Inspeksi Plant: $e");
      return [];
    }
  }
}

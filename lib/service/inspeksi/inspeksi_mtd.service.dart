...
class InspeksiMTDService {
  static const _storage = FlutterSecureStorage();
  static const baseUrl = "http://safety.borneo.co.id/inspeksi_mtd";

  static Future<bool> submitInspeksiMTD({
    ...
    debugPrint("SUBMIT INSPEKSI MTD STATUS: ${response.statusCode}");
    debugPrint("SUBMIT INSPEKSI MTD RESPONSE: $responseBody");

    return response.statusCode == 200 || response.statusCode == 201;
  }

  static Future<List<InspeksiMTDModel>> fetchInspeksiMTD() async {
    final token = await _storage.read(key: "jwt_token");
    final deviceId = await _storage.read(key: "device_id");
    ...
    try {
      ...
      return data.map((e) => InspeksiMTDModel.fromJson(e)).toList();
    } catch (e) {
      debugPrint("Error Fetch Inspeksi MTD: $e");
      return [];
    }
  }
}

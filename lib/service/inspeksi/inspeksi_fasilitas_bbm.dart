...
class InspeksiFasilitasBBMService {
  static const _storage = FlutterSecureStorage();
  static const baseUrl = "http://safety.borneo.co.id/inspeksi_fasilitas_bbm";

  static Future<bool> submitInspeksiFasilitasBBM({
    ...
    debugPrint("SUBMIT INSPEKSI FASILITAS BBM STATUS: ${response.statusCode}");
    debugPrint("SUBMIT INSPEKSI FASILITAS BBM RESPONSE: $responseBody");

    return response.statusCode == 200 || response.statusCode == 201;
  }

  static Future<List<InspeksiFasilitasBBMModel>>
  fetchInspeksiFasilitasBBM() async {
    final token = await _storage.read(key: "jwt_token");
    final deviceId = await _storage.read(key: "device_id");
    ...
    try {
      ...
      return data.map((e) => InspeksiFasilitasBBMModel.fromJson(e)).toList();
    } catch (e) {
      debugPrint("Error Fetch Inspeksi Fasilitas BBM: $e");
      return [];
    }
  }
}

...
class P2HServiceTruckService {
  static const _storage = FlutterSecureStorage();
  static const String baseUrl = "http://safety.borneo.co.id/p2h_service_truck";

  static Future<bool> submitP2HServiceTruck({
    ...
    required String penjelasanKondisiUnit,
    ...
    try {
      ...
      request.fields.addAll({
        ...
        "opsi_standar_keselamatan1": opsiKeselamatan1,
        "opsi_standar_keselamatan2": opsiKeselamatan2,
        "opsi_standar_keselamatan3": opsiKeselamatan3,

        "penjelasan_kondisi_unit": penjelasanKondisiUnit,
      ...
      if (kIsWeb) {
        ...
        if (filePaths != null && filePaths.isNotEmpty) {
          ...
          for (final path in filePaths.take(5)) {
            ...
            debugPrint(
              "Uploading P2H SERVICE TRUCK file $i/${filePaths.length}",
            );
      ...
      debugPrint("SUBMIT P2H SERVICE TRUCK STATUS: ${response.statusCode}");
      debugPrint("SUBMIT P2H SERVICE TRUCK RESPONSE: ${response.body}");
      ...
      debugPrint("Submit P2H SERVICE TRUCK Exception: $e");
      return false;
    } finally {
      client.close();
    }
  ...
  static Future<List<P2HServiceTruckModel>> fetchP2HServiceTruck() async {
    final token = await _storage.read(key: "jwt_token");
    final deviceId = await _storage.read(key: "device_id");
    ...
    try {
      ...
      return data.map((e) => P2HServiceTruckModel.fromJson(e)).toList();
    } catch (e) {
      debugPrint("Error Fetch P2H SERVICE TRUCK: $e");
      return [];
    }
  }
}

...
class P2HTruckService {
  static const _storage = FlutterSecureStorage();
  static const String baseUrl = "http://safety.borneo.co.id/p2h_truck";

  static Future<bool> submitP2HTruck({
    ...
    try {
      ...
      if (kIsWeb) {
        ...
        if (filePaths != null && filePaths.isNotEmpty) {
          ...
          for (final path in filePaths.take(5)) {
            ...
            debugPrint("Uploading P2H TRUCK file $i/${filePaths.length}");
      ...
      debugPrint("SUBMIT P2H TRUCK STATUS: ${response.statusCode}");
      debugPrint("SUBMIT P2H TRUCK RESPONSE: ${response.body}");
      ...
      debugPrint("Submit P2H TRUCK Exception: $e");
      return false;
    } finally {
      client.close();
    }
  ...
  static Future<List<P2HTruckModel>> fetchP2HTruck() async {
    final token = await _storage.read(key: "jwt_token");
    final deviceId = await _storage.read(key: "device_id");
    ...
    try {
      ...
      return data.map((e) => P2HTruckModel.fromJson(e)).toList();
    } catch (e) {
      debugPrint("Error Fetch P2H TRUCK: $e");
      return [];
    }
  }
}

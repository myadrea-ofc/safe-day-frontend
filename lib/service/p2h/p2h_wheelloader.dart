...
class P2HWheelLoaderService {
  static const _storage = FlutterSecureStorage();
  static const String baseUrl = "http://safety.borneo.co.id/p2h_wheelloader";

  static Future<bool> submitP2HWheelLoader({
    ...
    try {
      ...
      if (kIsWeb) {
        ...
        if (filePaths != null && filePaths.isNotEmpty) {
          ...
          for (final path in filePaths.take(5)) {
            ...
            debugPrint(
              "Uploading P2H WHEEL LOADER file $i/${filePaths.length}",
            );
      ...
      debugPrint("SUBMIT P2H WHEEL LOADER STATUS: ${response.statusCode}");
      debugPrint("SUBMIT P2H WHEEL LOADER RESPONSE: ${response.body}");
      ...
      debugPrint("Submit P2H WHEEL LOADER Exception: $e");
      return false;
    } finally {
      client.close();
    }
  ...
  static Future<List<P2HWheelLoaderModel>> fetchP2HWheelLoader() async {
    final token = await _storage.read(key: "jwt_token");
    final deviceId = await _storage.read(key: "device_id");
    ...
    try {
      ...
      return data.map((e) => P2HWheelLoaderModel.fromJson(e)).toList();
    } catch (e) {
      debugPrint("Error Fetch P2H WHEELLOADER: $e");
      return [];
    }
  }
}

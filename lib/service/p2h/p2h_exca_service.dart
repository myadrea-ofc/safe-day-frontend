...
class P2HExcaService {
  static const _storage = FlutterSecureStorage();
  static const String baseUrl = "http://safety.borneo.co.id/p2h_exca";

  static Future<bool> submitP2HExca({
    ...
    required String hmSekarang,
    required String waktuP2H,
    required String lokKerja,
    ...
    required String opsiStandarKeselamatan4,
    ...
    try {
      ...
      request.fields.addAll({
        ...
        "opsi_standar_keselamatan4": opsiStandarKeselamatan4,
      ...
      if (kIsWeb) {
        ...
        if (filePaths != null && filePaths.isNotEmpty) {
          ...
          for (final path in filePaths.take(5)) {
            ...
            debugPrint("Uploading P2H EXCAVATOR file $i/${filePaths.length}");
      ...
      debugPrint("SUBMIT P2H EXCAVATOR STATUS: ${response.statusCode}");
      debugPrint("SUBMIT P2H EXCAVATOR RESPONSE: ${response.body}");
      ...
      debugPrint("Submit P2H EXCAVATOR Exception: $e");
      return false;
    } finally {
      client.close();
    }
  ...
  static Future<List<P2HExcaModel>> fetchP2HExca() async {
    final token = await _storage.read(key: "jwt_token");
    final deviceId = await _storage.read(key: "device_id");
    ...
    try {
      ...
      return data.map((e) => P2HExcaModel.fromJson(e)).toList();
    } catch (e) {
      debugPrint("Error Fetch P2H EXCA: $e");
      return [];
    }
  }
}

...
class P2HFuelTruckService {
  static const _storage = FlutterSecureStorage();
  static const String baseUrl = "http://safety.borneo.co.id/p2h_fuel_truck";

  static Future<bool> submitP2HFuelTruck({
    ...
    try {
      ...
      if (kIsWeb) {
        ...
        if (filePaths != null && filePaths.isNotEmpty) {
          ...
          for (final path in filePaths.take(5)) {
            ...
            debugPrint("Uploading P2H FUEL TRUCK file $i/${filePaths.length}");
      ...
      debugPrint("SUBMIT P2H FUEL TRUCK STATUS: ${response.statusCode}");
      debugPrint("SUBMIT P2H FUEL TRUCK RESPONSE: ${response.body}");
      ...
      debugPrint("Submit P2H FUEL TRUCK Exception: $e");
      return false;
    } finally {
      client.close();
    }
  ...
  static Future<List<P2HFuelTruckModel>> fetchP2HFuelTruck() async {
    final token = await _storage.read(key: "jwt_token");
    final deviceId = await _storage.read(key: "device_id");
    ...
    try {
      ...
      return data.map((e) => P2HFuelTruckModel.fromJson(e)).toList();
    } catch (e) {
      debugPrint("Error Fetch P2H FUEL TRUCK: $e");
      return [];
    }
  }
}

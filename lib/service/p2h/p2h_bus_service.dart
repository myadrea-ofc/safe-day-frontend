...
class P2HBusService {
  ...
  static Future<bool> submitP2HBus({
    ...
    try {
      ...
      if (kIsWeb) {
        ...
        if (filePaths != null && filePaths.isNotEmpty) {
          ...
          for (final path in filePaths.take(5)) {
            ...
            debugPrint("Uploading P2H BUS file $i/${filePaths.length}");
      ...
      debugPrint("SUBMIT P2H BUS STATUS: ${response.statusCode}");
      debugPrint("SUBMIT P2H BUS RESPONSE: ${response.body}");
      ...
      debugPrint("Submit P2H BUS Exception: $e");
      return false;
    } finally {
      client.close();
    }
  ...
  static Future<List<P2HBusModel>> fetchP2HBus() async {
    ...
    try {
      ...
      debugPrint("Error Fetch P2H BUS: $e");
      return [];
    }
  }
}

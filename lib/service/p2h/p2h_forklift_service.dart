...
class P2HForkliftService {
  static const _storage = FlutterSecureStorage();
  static const String baseUrl = "http://safety.borneo.co.id/p2h_forklift";

  static Future<bool> submitP2HForklift({
    ...
    try {
      ...
      if (kIsWeb) {
        ...
        if (filePaths != null && filePaths.isNotEmpty) {
          ...
          for (final path in filePaths.take(5)) {
            ...
            debugPrint("Uploading P2H FORKLIFT file $i/${filePaths.length}");
      ...
      debugPrint("SUBMIT P2H FORKLIFT STATUS: ${response.statusCode}");
      debugPrint("SUBMIT P2H FORKLIFT RESPONSE: ${response.body}");
      ...
      debugPrint("Submit P2H FORKLIFT Exception: $e");
      return false;
    } finally {
      client.close();
    }
  ...
  static Future<List<P2HForkliftModel>> fetchP2HForklift() async {
    final token = await _storage.read(key: "jwt_token");
    final deviceId = await _storage.read(key: "device_id");
    ...
    try {
      ...
      return data.map((e) => P2HForkliftModel.fromJson(e)).toList();
    } catch (e) {
      debugPrint("Error Fetch P2H FORKLIFT: $e");
      return [];
    }
  }
}

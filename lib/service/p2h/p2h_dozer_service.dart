...
class P2HDozerService {
  ...
  static Future<bool> submitP2HDozer({
    ...
    try {
      ...
      if (kIsWeb) {
        ...
        if (filePaths != null && filePaths.isNotEmpty) {
          ...
          for (final path in filePaths.take(5)) {
            ...
            debugPrint("Uploading P2H DOZER file $i/${filePaths.length}");
      ...
      debugPrint("SUBMIT P2H DOZER STATUS: ${response.statusCode}");
      debugPrint("SUBMIT P2H DOZER RESPONSE: ${response.body}");
      ...
      debugPrint("Submit P2H DOZER Exception: $e");
      return false;
    } finally {
      client.close();
    }
  ...
  static Future<List<P2HDozerModel>> fetchP2HDozer() async {
    ...
    try {
      ...
      debugPrint("Error Fetch P2H DOZER: $e");
      return [];
    }
  }
}

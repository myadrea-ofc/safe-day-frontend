...
class P2HCraneService {
  static const _storage = FlutterSecureStorage();
  static const String baseUrl = "http://safety.borneo.co.id/p2h_crane";

  static Future<bool> submitP2HCrane({
    ...
    required String opsiItem34,
    required String opsiItem35,
    required String opsiItem36,

    required String opsiStandarKeselamatan1,
    required String opsiStandarKeselamatan2,
    required String opsiStandarKeselamatan3,
    ...
    try {
      ...
      request.fields.addAll({
        ...
        "opsi_item34": opsiItem34,
        "opsi_item35": opsiItem35,
        "opsi_item36": opsiItem36,

        "opsi_standar_keselamatan1": opsiStandarKeselamatan1,
        "opsi_standar_keselamatan2": opsiStandarKeselamatan2,
        "opsi_standar_keselamatan3": opsiStandarKeselamatan3,
      ...
      if (kIsWeb) {
        ...
        if (filePaths != null && filePaths.isNotEmpty) {
          ...
          for (final path in filePaths.take(5)) {
            ...
            debugPrint("Uploading P2H CRANE file $i/${filePaths.length}");
      ...
      debugPrint("SUBMIT P2H CRANE STATUS: ${response.statusCode}");
      debugPrint("SUBMIT P2H CRANE RESPONSE: ${response.body}");
      ...
      debugPrint("Submit P2H CRANE Exception: $e");
      return false;
    } finally {
      client.close();
    }
  ...
  static Future<List<P2HCraneModel>> fetchP2HCrane() async {
    final token = await _storage.read(key: "jwt_token");
    final deviceId = await _storage.read(key: "device_id");
    ...
    try {
      ...
      return data.map((e) => P2HCraneModel.fromJson(e)).toList();
    } catch (e) {
      debugPrint("Error Fetch P2H CRANE: $e");
      return [];
    }
  }
}

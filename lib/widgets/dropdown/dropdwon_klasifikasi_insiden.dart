...
class DropdownKlasifikasiInsiden extends StatefulWidget {
  final String? value;
  ...
  @override
  State<DropdownKlasifikasiInsiden> createState() =>
      _DropdownKlasifikasiInsidenState();
}

class _DropdownKlasifikasiInsidenState
    extends State<DropdownKlasifikasiInsiden> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          LabelText("Klasifikasi Insiden", showError: widget.showError),
          ...
          DropdownSearch<String>(
            ...
            dropdownDecoratorProps: DropDownDecoratorProps(
              dropdownSearchDecoration: InputDecoration(
                hintText: "Pilih klasifikasi insiden",
                hintStyle: const TextStyle(
                  color: Color(0xFF9CA3AF),
                  fontSize: 14,
          ...
          if (isOtherSelected) ...[
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                labelText: 'Input klasifikasi insiden lainnya',
                labelStyle: const TextStyle(
                  color: Color(0xFF6B7280),
                  fontSize: 14,
                ),
                hintText: 'Masukkan klasifikasi insiden manual',
                hintStyle: const TextStyle(
                  color: Color(0xFF9CA3AF),
                  fontSize: 14,
                ),

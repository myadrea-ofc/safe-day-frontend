...
import 'package:safety_apps/widgets/dropdown/no_unit/dropdown_no_dt.dart';
...
class FormP2HHeavyDuty extends StatefulWidget {
  @override
  _FormP2HHeavyDutyPageState createState() => _FormP2HHeavyDutyPageState();
}

class _FormP2HHeavyDutyPageState extends State<FormP2HHeavyDuty> {
  TextEditingController nama = TextEditingController();
  TextEditingController waktu = TextEditingController();
  TextEditingController hm_sekarang = TextEditingController();
  ...
  static const fHM = "Hour Meter Sekarang";
  ...
  static const fKimperBerlaku = "Jam Anda sebelum mengoperasikan unit";
  ...
  List<String> _getMissingFields() {
    ...
    if (hm_sekarang.text.trim().isEmpty) missing.add(fHM);
  ...
  void initState() {
    ...
    nama.addListener(() {
      ...
      if (hm_sekarang.text.trim().isNotEmpty) {
        _clearMissing(fHM);
      }
    });
  }
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CheckboxOther(
                    selected: perusahaan,
                    options: ["PT BBP", "PT MCM", "CV EBB", "PT Liebherr"],
                    onChanged: (v) {
                  ...
                  LabelText(
                    "Tuliskan temuan P2H Anda terkait kondisi unit apabila ada kerusakan atau kendala di unit yang dioperasikan",
                  ...
                  SizedBox(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                        onPressed: _isSubmitting ? null : submitP2HHeavyDuty,
  ...
  void submitP2HHeavyDuty() async {
    ...
    try {
      ok = await P2HDTService.submitP2HDT(
        nama: nama.text,
        jabatan: jabatan ?? "",

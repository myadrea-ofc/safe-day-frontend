...
class _FormP2HHeavyDutyPageState extends State<FormP2HHeavyDuty> {
  ...
  Future<bool> _submitOnce(Map<String, dynamic> payload) async {
    return await P2HDTService.submitP2HDT(
      ...
      _submitTimeout,
      onTimeout: () {
        debugPrint("SUBMIT P2H HEAVY DUTY TIMEOUT");
        return false;
      },
    );
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  SearchableMasterDropdown(
                    ...
                    endpoint: "master/no-lambung-unit?unit_id=2",
  ...
  void submitP2HHeavyDuty() async {
    ...
    try {
      ...
      if (!ok) {
        await PendingFormHelper.saveP2HHeavyDuty(
          payload: payload,
          filePaths: filePaths,
        );
        savedToPending = true;
    ...
    if (ok) {
      StatusDialog.show(
        ...
        title: "Berhasil",
        message: "Data P2H Heavy Duty berhasil dikirim.",
        onDone: () {
      ...
      StatusDialog.show(
        ...
        type: StatusDialogType.error,
        title: "Gagal",
        message: "Data P2H Heavy Duty gagal dikirim.",
        onDone: () => Navigator.pop(context),
      );
    }
  }

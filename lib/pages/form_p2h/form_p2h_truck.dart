...
import 'package:safety_apps/widgets/dropdown/no_unit/dropdown_no_truck.dart';
...
class _FormP2HTruckHaulingPageState extends State<FormP2HTruckHauling> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  LabelText(
                    ...
                    showError: _missingFields.contains(status_siap),
                  ),
                  OpsiRow(
  ...
  void submitP2HTruck() async {
    ...
    try {
      ok = await P2HTruckService.submitP2HTruck(
        nama: nama.text,
        jabatan: jabatan ?? "",

...
class FormP2HTruckHauling extends StatefulWidget {
  @override
  _FormP2HTruckHaulingPageState createState() =>
      _FormP2HTruckHaulingPageState();
}

class _FormP2HTruckHaulingPageState extends State<FormP2HTruckHauling> {
  ...
  Future<bool> _submitOnce(Map<String, dynamic> payload) async {
    return await P2HTruckService.submitP2HTruck(
      ...
      _submitTimeout,
      onTimeout: () {
        debugPrint("SUBMIT P2H TRUCK TIMEOUT");
        return false;
      },
    );
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  SearchableMasterDropdown(
                    ...
                    endpoint: "master/no-lambung-unit?unit_id=9",
                  ...
                  LabelText("Item Pemerikasaan Truck"),
                  ...
                  LabelText(
                    "Tuliskan temuan P2H unit truck Anda (Apbila ada masalah)",
                  ...
                  SizedBox(height: 15),
                  LabelText(
                    "Apakah Anda sudah siap untuk bekerja baik secara mental dan fisik serta memiliki KIMPER dan APD & selalu pakai sabuk pengaman",
                  ...
                  SizedBox(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                        onPressed: _isSubmitting ? null : submitP2HTruck,
  ...
  void submitP2HTruck() async {
    ...
    try {
      ...
      if (!ok) {
        await PendingFormHelper.saveP2HTruckHauling(
          payload: payload,
          filePaths: filePaths,
        );
        savedToPending = true;
    ...
    if (ok) {
      StatusDialog.show(
        ...
        title: "Berhasil",
        message: "Data P2H Truck Hauling berhasil dikirim.",
        onDone: () {
      ...
      StatusDialog.show(
        ...
        type: StatusDialogType.error,
        title: "Gagal",
        message: "Data P2H Truck Hauling gagal dikirim.",
        onDone: () => Navigator.pop(context),
      );
    }
  }

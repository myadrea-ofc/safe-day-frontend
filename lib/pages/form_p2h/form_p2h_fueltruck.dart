...
class FormP2HFuelTruck extends StatefulWidget {
  @override
  _FormP2HFuelTruckPageState createState() => _FormP2HFuelTruckPageState();
}

class _FormP2HFuelTruckPageState extends State<FormP2HFuelTruck> {
  ...
  List<String> _getMissingFields() {
    ...
    if (no_lambung_unit == null) missing.add(fNoLambungUnit);
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CheckboxOther(
                    selected: no_lambung_unit,
                    options: [
                      "Fuel Truck 8-ISU 1001H",
                      "Fuel Truck 24-HIN 2019",
                      "Fuel Truck 24-HIN 2020",
                      "Fuel Truck 24-HIN 2021",
                    ],
                    onChanged: (v) {
                      setState(() => no_lambung_unit = v);
                  ...
                  LabelText(
                    "Berapa jam tidur Anda sebelum mengoperasikan unit",
                  ...
                  SizedBox(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                        onPressed: _isSubmitting ? null : submitP2HFuelTruck,
  ...
  void submitP2HFuelTruck() async {
    ...
    try {
      ok = await P2HFuelTruckService.submitP2HFuelTruck(
        nama: nama.text,
        nrp: nrp.text,
        jabatan: jabatan ?? "",

...
class _FormP2HWaterTruckPageState extends State<FormP2HWaterTruck> {
  ...
  Future<bool> _submitOnce(Map<String, dynamic> payload) async {
    return await P2HWaterTruckService.submitP2HWaterTruck(
      ...
      _submitTimeout,
      onTimeout: () {
        debugPrint("SUBMIT P2H WATER TRUCK TIMEOUT");
        return false;
      },
    );
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  SearchableMasterDropdown(
                    ...
                    endpoint: "master/no-lambung-unit?unit_id=10",
  ...
  void submitP2HWaterTruck() async {
    ...
    try {
      ...
      if (!ok) {
        await PendingFormHelper.saveP2HWaterTruck(
          payload: payload,
          filePaths: filePaths,
        );
        savedToPending = true;
    ...
    if (ok) {
      StatusDialog.show(
        ...
        title: "Berhasil",
        message: "Data P2H Water Truck berhasil dikirim.",
        onDone: () {
      ...
      StatusDialog.show(
        ...
        type: StatusDialogType.error,
        title: "Gagal",
        message: "Data P2H Water Truck gagal dikirim.",
        onDone: () => Navigator.pop(context),
      );
    }
  }

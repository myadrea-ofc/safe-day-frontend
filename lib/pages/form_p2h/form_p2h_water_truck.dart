...
class FormP2HWaterTruck extends StatefulWidget {
  @override
  _FormP2HWaterTruckPageState createState() => _FormP2HWaterTruckPageState();
}

class _FormP2HWaterTruckPageState extends State<FormP2HWaterTruck> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  CheckboxForm(
                    ...
                    options: [
                      "Water Truck 24-HIN 1077",
                      "Water Truck 24-HIN 1078",
                      "Water Truck 24-HIN 1079",
                    ],
                    onChanged: (v) {
                  ...
                  LabelText("Item Pemerikasaan Water Truck"),
                  ...
                  OpsiRow(
                    ...
                    onSelected: (v) => setState(() => status_keadaan3 = v),
                  ),
                  ...
                  SizedBox(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                        onPressed: _isSubmitting ? null : submitP2HWaterTruck,
  ...
  void submitP2HWaterTruck() async {
    ...
    try {
      ok = await P2HWaterTruckService.submitP2HWaterTruck(
        nama: nama.text,
        nrp: nrp.text,
        jabatan: jabatan ?? "",
        ...
        filePaths: selectedDokumen.map((e) => e.path).toList(),
      );
    } catch (_) {
      ok = false;
    }

...
class _FormP2HWheelLoaderPageState extends State<FormP2HWheelLoader> {
  ...
  Future<bool> _submitOnce(Map<String, dynamic> payload) async {
    return await P2HWheelLoaderService.submitP2HWheelLoader(
      ...
      _submitTimeout,
      onTimeout: () {
        debugPrint("SUBMIT P2H WHEEL LOADER TIMEOUT");
        return false;
      },
    );
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  SearchableMasterDropdown(
                    ...
                    endpoint: "master/no-lambung-unit?unit_id=11",
  ...
  void submitP2HWheelLoader() async {
    ...
    try {
      ...
      if (!ok) {
        await PendingFormHelper.saveP2HWheelLoader(
          payload: payload,
          filePaths: filePaths,
        );
        savedToPending = true;
    ...
    if (ok) {
      StatusDialog.show(
        ...
        title: "Berhasil",
        message: "Data P2H Wheel Loader berhasil dikirim.",
        onDone: () {
      ...
      StatusDialog.show(
        ...
        type: StatusDialogType.error,
        title: "Gagal",
        message: "Data P2H Wheel Loader gagal dikirim.",
        onDone: () => Navigator.pop(context),
      );
    }
  }

...
class FormP2HCrane extends StatefulWidget {
  @override
  _FormP2HCranePageState createState() => _FormP2HCranePageState();
}

class _FormP2HCranePageState extends State<FormP2HCrane> {
  ...
  Map<String, dynamic> _buildPayload({required List<String> filePaths}) {
    return {
      ...
      'opsiItem34': opsiitem34 ?? "",
      'opsiItem35': opsiitem35 ?? "",
      'opsiItem36': opsiitem36 ?? "",
              ...
              child: Column(
                ...
                children: [
                  ...
                  SearchableMasterDropdown(
                    ...
                    endpoint: "master/no-lambung-unit?unit_id=7",
                  ...
                  LabelText("Item Pemerikasaan Crane"),
                  ...
                  LabelText(
                    "Sabuk Keselamatan",
                    showError: _missingFields.contains("$fOpsiPrefix 34"),
                  ),
                  OpsiRow3Ltna(
                    selected: opsiitem34,
                    onSelected: (v) {
                      setState(() => opsiitem34 = v);
                      _clearMissing("$fOpsiPrefix 34");
                    },
                  ),

                  LabelText(
                    "Radio Komunikasi",
                    showError: _missingFields.contains("$fOpsiPrefix 35"),
                  ),
                  OpsiRow3Ltna(
                    selected: opsiitem35,
                    onSelected: (v) {
                      setState(() => opsiitem35 = v);
                      _clearMissing("$fOpsiPrefix 35");
                    },
                  ),

                  LabelText(
                    "SIO / SIMPER",
                    showError: _missingFields.contains("$fOpsiPrefix 36"),
                  ),
                  OpsiRow3Ltna(
                    selected: opsiitem36,
                    onSelected: (v) {
                      setState(() => opsiitem36 = v);
                      _clearMissing("$fOpsiPrefix 36");
                    },
                  ),
                  ...
                  SizedBox(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                        onPressed: _isSubmitting ? null : submitP2HCrane,
  ...
  void submitP2HCrane() async {
    ...
    try {
      ...
      if (!ok) {
        await PendingFormHelper.saveP2HCrane(
          payload: payload,
          filePaths: filePaths,
        );
        savedToPending = true;
    ...
    if (ok) {
      StatusDialog.show(
        ...
        title: "Berhasil",
        message: "Data P2H Crane berhasil dikirim.",
        onDone: () {
      ...
      StatusDialog.show(
        ...
        type: StatusDialogType.error,
        title: "Gagal",
        message: "Data P2H Crane gagal dikirim.",
        onDone: () => Navigator.pop(context),
      );
    }
  }

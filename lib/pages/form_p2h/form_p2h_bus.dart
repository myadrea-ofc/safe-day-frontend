...
class FormP2HBus extends StatefulWidget {
  @override
  _FormP2HBusPageState createState() => _FormP2HBusPageState();
}

class _FormP2HBusPageState extends State<FormP2HBus> {
  TextEditingController nama = TextEditingController();
  TextEditingController waktu = TextEditingController();
  TextEditingController nama_pembicara = TextEditingController();
  TextEditingController km_sekarang = TextEditingController();
  ...
  static const fKM = "Hour Meter";
  static const fNoLambungUnit = "No Lambung Unit";
  static const fShift = "Shift Kerja";
  ...
  static const fStandarMasukTambangPrefix = "Standar Masuk Tambang";
  static const fStandarKeselamatanPrefix = "Standar Keselamatan";
  ...
  List<String> _getMissingFields() {
    ...
    if (selectedDokumen.isEmpty && laporan_temuan.text.isEmpty) {
      missing.add(fDokumen);
    }
    ...
    standarKeselamatanMap.forEach((i, v) {
      if (v == null || v.isEmpty) {
        missing.add("$fStandarKeselamatanPrefix $i");
      }
    });

    standarMasukTambangMap.forEach((i, v) {
      if (v == null || v.isEmpty) {
        missing.add("$fStandarMasukTambangPrefix $i");
      }
    });
  ...
  void initState() {
    ...
    nama.addListener(() {
      ...
      if (km_sekarang.text.trim().isNotEmpty) {
        _clearMissing(fKM);
      }
    });
  }
  ...
  Map<String, dynamic> _buildP2HBusPayload({
    required List<String> processedFilePaths,
  }) {
    return {
      'nama': nama.text,
      'jabatan': jabatan ?? "",
      ...
      'opsiKeselamatan1': opsistandardkeselamatan1 ?? "",
      'opsiKeselamatan2': opsistandardkeselamatan2 ?? "",
      'opsiKeselamatan3': opsistandardkeselamatan3 ?? "",
      'opsiKeselamatan4': opsistandardkeselamatan4 ?? "",

      'opsiMasukTambang1': opsistandardmasuktambang1 ?? "",
      'opsiMasukTambang2': opsistandardmasuktambang2 ?? "",
      'opsiMasukTambang3': opsistandardmasuktambang3 ?? "",
      'opsiMasukTambang4': opsistandardmasuktambang4 ?? "",
      'opsiMasukTambang5': opsistandardmasuktambang5 ?? "",
  ...
  Future<bool> _submitP2HBusOnce(Map<String, dynamic> payload) async {
    return await P2HBusService.submitP2HBus(
      ...
      opsiMasukTambang1: (payload['opsiMasukTambang1'] ?? '').toString().trim(),
      opsiMasukTambang2: (payload['opsiMasukTambang2'] ?? '').toString().trim(),
      opsiMasukTambang3: (payload['opsiMasukTambang3'] ?? '').toString().trim(),
      opsiMasukTambang4: (payload['opsiMasukTambang4'] ?? '').toString().trim(),
      opsiMasukTambang5: (payload['opsiMasukTambang5'] ?? '').toString().trim(),
      ...
      _submitTimeout,
      onTimeout: () {
        debugPrint("SUBMIT P2H BUS TIMEOUT");
        return false;
      },
    );
  }
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CheckboxOther(
                    selected: jabatan,
                    options: ["Driver Bus", "Driver Spare", "Pengawas"],
                    onChanged: (v) {
                      setState(() => jabatan = v);
                  ...
                  SearchableMasterDropdown(
                    ...
                    endpoint: "master/no-lambung-unit?unit_id=1",
                  ...
                  LabelText(fKM, showError: _missingFields.contains(fKM)),
                  InputField(
                    controller: km_sekarang,
                    hint: "Masukkan HM Bus",
                    onChanged: (_) {
                      if (km_sekarang.text.trim().isNotEmpty) {
                        _clearMissing(fKM);
                      }
                  ...
                  LabelText(fShift, showError: _missingFields.contains(fShift)),
                  CheckboxForm(
                    selected: shift_kerja,
                    options: ["Shift I", "Shift II"],
                    onChanged: (v) {
                      setState(() => shift_kerja = v);
                      _clearMissing(fShift);
                    },
                  ),
                  ...
                  OpsiRow3Ltna2(
                    ...
                    onSelected: (v) {
                      ...
                      _clearMissing("$fStandarKeselamatanPrefix 1");
                    },
                  ),
                  ...
                  OpsiRow3Ltna2(
                    ...
                    onSelected: (v) {
                      ...
                      _clearMissing("$fStandarKeselamatanPrefix 2");
                    },
                  ),
                  ...
                  OpsiRow3Ltna2(
                    ...
                    onSelected: (v) {
                      ...
                      _clearMissing("$fStandarKeselamatanPrefix 3");
                    },
                  ),
                  ...
                  OpsiRow3Ltna2(
                    ...
                    onSelected: (v) {
                      ...
                      _clearMissing("$fStandarKeselamatanPrefix 4");
                    },
                  ),
                  ...
                  OpsiRow3Ltna2(
                    ...
                    onSelected: (v) {
                      ...
                      _clearMissing("$fStandarMasukTambangPrefix 1");
                    },
                  ),
                  ...
                  OpsiRow3Ltna2(
                    ...
                    onSelected: (v) {
                      ...
                      _clearMissing("$fStandarMasukTambangPrefix 2");
                    },
                  ),
                  ...
                  OpsiRow3Ltna2(
                    ...
                    onSelected: (v) {
                      ...
                      _clearMissing("$fStandarMasukTambangPrefix 3");
                    },
                  ),
                  ...
                  OpsiRow3Ltna2(
                    ...
                    onSelected: (v) {
                      ...
                      _clearMissing("$fStandarMasukTambangPrefix 4");
                    },
                  ),
                  ...
                  OpsiRow3Ltna2(
                    ...
                    onSelected: (v) {
                      ...
                      _clearMissing("$fStandarMasukTambangPrefix 5");
                    },
                  ),
                  ...
                  SizedBox(height: 15),
                  LabelText(
                    "Apakah Anda sudah siap untuk bekerja baik secara mental dan fisik serta melakukan P2H dengan benar dan telap menggunakan APD",
                  ...
                  SizedBox(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                        onPressed: _isSubmitting ? null : submitP2HBus,
  ...
  void submitP2HBus() async {
    ...
    final processedFilePaths = kIsWeb
        ? <String>[]
        : processedFiles.map((f) => f.path).toList();

    final payload = _buildP2HBusPayload(processedFilePaths: processedFilePaths);
    ...
    try {
      ok = await RetrySubmitHelper.run(
        ...
        action: () => _submitP2HBusOnce(payload),
      );

      if (!ok) {
        await PendingFormHelper.saveP2HBus(
          payload: payload,
          filePaths: processedFilePaths,
        );
        savedToPending = true;
    ...
    if (ok) {
      StatusDialog.show(
        ...
        message: "Data P2H Bus berhasil dikirim.",
        onDone: () {
          Navigator.pop(context);
          Navigator.pop(context);
        },
      ...
      StatusDialog.show(
        ...
        message: "Data P2H Bus gagal dikirim.",
        onDone: () {
          Navigator.pop(context);
        },
      );

...
class _FormP2HExcavatorPageState extends State<FormP2HExcavator> {
  ...
  Future<bool> _submitOnce(Map<String, dynamic> payload) async {
    return await P2HExcaService.submitP2HExca(
      ...
      _submitTimeout,
      onTimeout: () {
        debugPrint("SUBMIT P2H EXCAVATOR TIMEOUT");
        return false;
      },
    );
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  SearchableMasterDropdown(
                    ...
                    endpoint: "master/no-lambung-unit?unit_id=3",
  ...
  void submitP2HExca() async {
    ...
    try {
      ...
      if (!ok) {
        await PendingFormHelper.saveP2HExcavator(
          payload: payload,
          filePaths: filePaths,
        );
        savedToPending = true;
    ...
    if (ok) {
      StatusDialog.show(
        ...
        title: "Berhasil",
        message: "Data P2H Excavator berhasil dikirim.",
        onDone: () {
      ...
      StatusDialog.show(
        ...
        type: StatusDialogType.error,
        title: "Gagal",
        message: "Data P2H Excavator gagal dikirim.",
        onDone: () => Navigator.pop(context),
      );
    }
  }

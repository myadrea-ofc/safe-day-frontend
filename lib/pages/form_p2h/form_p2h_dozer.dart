...
import 'package:safety_apps/widgets/dropdown/no_unit/dropdown_no_dozer.dart';
...
class _FormP2HDozerPageState extends State<FormP2HDozer> {
  ...
  static const fNoLambungUnit = "No Lambung WUnit";
  ...
  void submitP2HDozer() async {
    ...
    try {
      ok = await P2HDozerService.submitP2HDozer(
        nama: nama.text,
        nrp: nrp.text,
        jabatan: jabatan ?? "",

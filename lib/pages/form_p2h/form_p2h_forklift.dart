...
class _FormP2HForkliftPageState extends State<FormP2HForklift> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  CheckboxForm(
                    ...
                    options: ["FORKLIFT-XXX", "FORKLIFT-XX1"],
                    onChanged: (v) {
                  ...
                  LabelText(
                    ...
                    showError: _missingFields.contains(kimper_berlaku),
                  ),
                  CheckboxForm(
                  ...
                  LabelText(
                    ...
                    showError: _missingFields.contains(jam_tidur),
                  ),
                  CheckboxForm(
                    selected: jam_tidur,
  ...
  void submitP2HForklift() async {
    ...
    bool ok = false;
    try {
      ok = await P2HForkliftService.submitP2HForklift(
        nama: nama.text,
        nrp: nrp.text,

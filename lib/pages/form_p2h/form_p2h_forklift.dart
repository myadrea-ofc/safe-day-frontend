...
class FormP2HForklift extends StatefulWidget {
  @override
  _FormP2HForkliftPageState createState() => _FormP2HForkliftPageState();
}

class _FormP2HForkliftPageState extends State<FormP2HForklift> {
  ...
  static const fKimperBerlaku = "Kimper Berlaku";
  ...
  Future<bool> _submitOnce(Map<String, dynamic> payload) async {
    return await P2HForkliftService.submitP2HForklift(
      ...
      _submitTimeout,
      onTimeout: () {
        debugPrint("SUBMIT P2H FORKLIFT TIMEOUT");
        return false;
      },
    );
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  SearchableMasterDropdown(
                    ...
                    endpoint: "master/no-lambung-unit?unit_id=8",
                  ...
                  LabelText("Item Pemerikasaan Forklift"),
                  ...
                  LabelText(
                    "Level Air Aki / Battery Water Level",
                  ...
                  SizedBox(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                        onPressed: _isSubmitting ? null : submitP2HForklift,
  ...
  void submitP2HForklift() async {
    ...
    try {
      ...
      if (!ok) {
        await PendingFormHelper.saveP2HForklift(
          payload: payload,
          filePaths: filePaths,
        );
        savedToPending = true;
    ...
    if (ok) {
      StatusDialog.show(
        ...
        title: "Berhasil",
        message: "Data P2H Forklift berhasil dikirim.",
        onDone: () {
      ...
      StatusDialog.show(
        ...
        type: StatusDialogType.error,
        title: "Gagal",
        message: "Data P2H Forklift gagal dikirim.",
        onDone: () => Navigator.pop(context),
      );
    }
  }

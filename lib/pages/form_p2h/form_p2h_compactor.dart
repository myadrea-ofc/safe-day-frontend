...
class FormP2HCompactor extends StatefulWidget {
  @override
  _FormP2HCompactorPageState createState() => _FormP2HCompactorPageState();
}

class _FormP2HCompactorPageState extends State<FormP2HCompactor> {
  ...
  Future<bool> _submitOnce(Map<String, dynamic> payload) async {
    return await P2HCompactorService.submitP2HCompactor(
      ...
      noLambungUnit: payload['noLambungUnit'],
      perusahaan: payload['perusahaan'],
      lokasiKerja: payload['lokasiKerja'],
      hmUnit: payload['hmUnit'],
      tanggal: payload['tanggal'],
      opsiItem1: payload['opsiItem1'],
      opsiItem2: payload['opsiItem2'],
      opsiItem3: payload['opsiItem3'],
      opsiItem4: payload['opsiItem4'],
      opsiItem5: payload['opsiItem5'],
      opsiItem6: payload['opsiItem6'],
      opsiItem7: payload['opsiItem7'],
      opsiItem8: payload['opsiItem8'],
      opsiItem9: payload['opsiItem9'],
      opsiItem10: payload['opsiItem10'],
      opsiItem11: payload['opsiItem11'],
      opsiItem12: payload['opsiItem12'],
      opsiItem13: payload['opsiItem13'],
      opsiItem14: payload['opsiItem14'],
      opsiItem15: payload['opsiItem15'],
      opsiItem16: payload['opsiItem16'],
      opsiItem17: payload['opsiItem17'],
      opsiItem18: payload['opsiItem18'],
      opsiItem19: payload['opsiItem19'],
      opsiItem20: payload['opsiItem20'],
      opsiItem21: payload['opsiItem21'],
      opsiItem22: payload['opsiItem22'],
      opsiItem23: payload['opsiItem23'],
      opsiItem24: payload['opsiItem24'],
      opsiItem25: payload['opsiItem25'],
      opsiItem26: payload['opsiItem26'],
      opsiItem27: payload['opsiItem27'],
      opsiItem28: payload['opsiItem28'],
      opsiItem29: payload['opsiItem29'],
      opsiItem30: payload['opsiItem30'],
      ...
      kimperBerlaku: payload['kimperBerlaku'],
      jamTidur: payload['jamTidur'],
      statusKeadaan1: payload['statusKeadaan1'],
      statusKeadaan2: payload['statusKeadaan2'],
      statusKeadaan3: payload['statusKeadaan3'],
      statusKeadaan4: payload['statusKeadaan4'],
      statusKeadaan5: payload['statusKeadaan5'],
      statusKeadaan6: payload['statusKeadaan6'],
      statusSiap: payload['statusSiap'],
      filePaths: kIsWeb
          ? []
          : List<String>.from(payload['filePaths'] ?? const []),
      fileBytesList: kIsWeb ? selectedDokumenBytes : [],
      fileNames: kIsWeb ? selectedDokumenNames : [],
    ).timeout(_submitTimeout, onTimeout: () => false);
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  SearchableMasterDropdown(
                    ...
                    endpoint: "master/no-lambung-unit?unit_id=14",
                  ...
                  LabelText("Item Pemerikasaan Compactor"),
                  ...
                  SizedBox(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                        onPressed: _isSubmitting ? null : submitP2HCompactor,
  ...
  void submitP2HCompactor() async {
      ...
      ok = await RetrySubmitHelper.run(
        ...
        onProgress: (attempt, maxRetry) {
          _submitProgressText.value = attempt == 1
              ? "Mengirim data..."
              : "Retry $attempt dari $maxRetry";
        },
        action: () => _submitOnce(payload),
      );

      if (!ok) {
        await PendingFormHelper.saveP2HCompactor(
          payload: payload,
          filePaths: filePaths,
        );
        savedToPending = true;
    ...
    if (ok) {
      ...
      StatusDialog.show(
        ...
        title: "Pending",
        message: "Data disimpan dan akan dikirim ulang",
        onDone: () => Navigator.pop(context),
      );
    } else {
      StatusDialog.show(

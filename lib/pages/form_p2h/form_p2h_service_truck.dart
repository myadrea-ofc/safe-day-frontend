...
class FormServiceTruck extends StatefulWidget {
  @override
  _FormServiceTruckPageState createState() => _FormServiceTruckPageState();
}

class _FormServiceTruckPageState extends State<FormServiceTruck> {
  TextEditingController nama = TextEditingController();
  TextEditingController tanggal = TextEditingController();
  TextEditingController waktu = TextEditingController();
  TextEditingController hm_unit = TextEditingController();
  TextEditingController penjelasan_kondisi_unit = TextEditingController();
  ...
  void dispose() {
    ...
    waktu.dispose();
    hm_unit.dispose();
    penjelasan_kondisi_unit.dispose();
  ...
  static const fPenjelasanKondisiUnit = "Penjelasan Kondisi Unit";
  ...
  static const fJamOperasi = "Jam Anda sebelum mengoperasikan unit";
  ...
  List<String> _getMissingFields() {
    ...
    if (penjelasan_kondisi_unit.text.trim().isEmpty)
      missing.add(fPenjelasanKondisiUnit);
    ...
    if (jam_operasi == null) missing.add(fJamOperasi);
  ...
  void initState() {
    ...
    nama.addListener(() {
      ...
      if (penjelasan_kondisi_unit.text.trim().isNotEmpty) {
        _clearMissing(fPenjelasanKondisiUnit);
      }
  ...
  Map<String, dynamic> _buildPayload({required List<String> filePaths}) {
    return {
      ...
      'penjelasanKondisiUnit': penjelasan_kondisi_unit.text,
      'jamOperasi': jam_operasi ?? "",
  ...
  Future<bool> _submitOnce(Map<String, dynamic> payload) async {
    return await P2HServiceTruckService.submitP2HServiceTruck(
      ...
      _submitTimeout,
      onTimeout: () {
        debugPrint("SUBMIT P2H SERVICE TRUCK TIMEOUT");
        return false;
      },
    );
  }
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CheckboxOther(
                    selected: jabatan,
                    options: ["Driver Man Haul", "Driver DT", "Pengawas"],
                    onChanged: (v) {
                      setState(() => jabatan = v);
                  ...
                  SearchableMasterDropdown(
                    ...
                    endpoint: "master/no-lambung-unit?unit_id=13",
                  ...
                  LabelText(
                    ...
                    showError: _missingFields.contains(fPenjelasanKondisiUnit),
                  ),
                  InputField(
                    controller: penjelasan_kondisi_unit,
                    hint: "Masukkan kondisi Unit",
                    onChanged: (v) {
                      if (v.trim().isNotEmpty) {
                        _clearMissing(fPenjelasanKondisiUnit);
                      }
                  ...
                  LabelText(
                    "Jam Anda sebelum mengoperasikan unit",
                    showError: _missingFields.contains(fJamOperasi),
                  ),
                  CheckboxForm(
                    selected: jam_operasi,
                    options: ["1 ", "2 ", "3 ", "4 ", "5 ", "6 ", "7", "8"],
                    onChanged: (v) {
                      setState(() => jam_operasi = v);
                      _clearMissing(fJamOperasi);
                    },
                  ),
                  ...
                  SizedBox(height: 15),
                  LabelText(
                    "Apakah Anda sudah siap untuk bekerja baik secara mental dan fisik serta memiliki Kimper untuk mengoperasikan unit - jangan lupa pakai sabuk pengaman?",
                  ...
                  SizedBox(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                        onPressed: _isSubmitting ? null : submitServiceTruck,
  ...
  void submitServiceTruck() async {
    ...
    try {
      ...
      if (!ok) {
        await PendingFormHelper.saveP2HServiceTruck(
          payload: payload,
          filePaths: filePaths,
        );
        savedToPending = true;
    ...
    if (ok) {
      StatusDialog.show(
        ...
        title: "Berhasil",
        message: "Data P2H Service Truck berhasil dikirim.",
        onDone: () {
      ...
      StatusDialog.show(
        ...
        type: StatusDialogType.error,
        title: "Gagal",
        message: "Data P2H Service Truck gagal dikirim.",
        onDone: () => Navigator.pop(context),
      );
    }
  }

...
class _FormServiceTruckPageState extends State<FormServiceTruck> {
  ...
  List<String> _getMissingFields() {
    ...
    if (penjelasan_kondisi_unit.text.trim().isEmpty) missing.add(fHM);
    ...
    if (penjelasan_kondisi_unit.text.isEmpty)
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  OpsiRow3Ltna(
                    selected: opsiitem13,
                    onSelected: (v) => setState(() => opsiitem13 = v),
                  ),
  ...
  void submitServiceTruck() async {
    ...
    try {
      ok = await P2HServiceTruckService.submitP2HServiceTruck(
        nama: nama.text,
        jabatan: jabatan ?? "",

...
class FormInspeksiFasilitasBBM extends StatefulWidget {
  @override
  _FormInspeksiFasilitasBBMPageState createState() =>
      _FormInspeksiFasilitasBBMPageState();
}

class _FormInspeksiFasilitasBBMPageState
    extends State<FormInspeksiFasilitasBBM> {
  ...
  Map<String, dynamic> _buildInspeksiFasilitasBBMPayload() {
    return {
      'nama': nama.text,
      'nrp': nrp.text,
  ...
  List<String> _buildInspeksiFasilitasBBMFilePaths() {
    if (kIsWeb) return [];
  ...
  Future<bool> _submitInspeksiFasilitasBBMOnce(
    ...
    return await InspeksiFasilitasBBMService.submitInspeksiFasilitasBBM(
      ...
      _submitTimeout,
      onTimeout: () {
        debugPrint("SUBMIT INSPEKSI FASILITAS BBM TIMEOUT");
        return false;
      },
    );
  }
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  LabelText(
                    "Penerangan area yang mencukupi",
  ...
  void submitInspeksiFasilitasBBM() async {
    ...
    final payload = _buildInspeksiFasilitasBBMPayload();
    final filePaths = _buildInspeksiFasilitasBBMFilePaths();
    ...
    try {
      ok = await RetrySubmitHelper.run(
        ...
        action: () => _submitInspeksiFasilitasBBMOnce(payload),
      );

      if (!ok) {
        await PendingFormHelper.saveInspeksiFasilitasBBM(
          payload: payload,
          filePaths: filePaths,
        );
        savedToPending = true;
